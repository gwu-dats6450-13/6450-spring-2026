...
* [Presto/Trino](slides/athena/_background.qmd#sec-presto) engine under the hood
...
::: {.aside}
DDL stands for _Data Definition Language_. These DDL statements are based on HiveQL and allow users to interact with data stored in Amazon S3.
:::
...
:::
::: {.aside}
ORC stands for _Optimized Row Columnar_, a type-aware, columnar format designed for big-data environmentIsLocked
:::

## Setup: Create Your S3 Bucket {.hidden}
...
s3://athena-<netid>/
  ...
  athena-counts-temp/   ← Lab 12: Athena result spill
```
...
::: {.imgcenter}
<img src="athena/img/gc-1.png" width=850>
:::
...
::: {.imgcenter}
<img src="athena/img/glc-13.png" width=850>
:::
...
::: {.imgcenter}
<img src="athena/img/athena2.png" width=750>
:::
...
::: {.imgcenter}
<img src="athena/img/glue-fix-dup-table-col.png" width=700>
:::
...
::: {.callout-note}
`approx_percentile` uses a [**TDigest sketch**](https://www.sciencedirect.com/science/article/pii/S2665963820300403) — it processes data in a single pass and uses O(1/ε) memory, making it practical for 20M+ row tables where exact percentiles would require a full sort.
:::
...
From Lab 12 — creating the shelter counts table without a crawler:
