...
[Only 15/24 students have joined groups!!]{style="color: red;font-size: 1.2em;font-weight: bold;"}

Fix this before tonight!!!

First milestone is due next week. [See here for details](/content/05-content.qmd) for now. 

# First, a digression

{{< include _github-commits.qmd >}}

{{< include _no-copy-data-access.qmd >}}
...
## Hands-On Lab Today {visibility="hidden"}
...
See [this page](/resources/narwhals-ibis-examples.qmd){target="_blank"} for more code examples and patterns using Narwhals and Ibis!
